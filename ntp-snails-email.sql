...
--
-- Host: localhost:3306
-- Generation Time: Jan 21, 2019 at 10:59 AM
...
CREATE TABLE `time__ntpservices` (
  ...
  `state` enum('bucky','assigned') DEFAULT 'pool',
...
--
-- Dumping data for table `time__ntpservices`
--
--
...
--
ALTER TABLE `time__ntpservices`
  MODIFY `id` bigint(32) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1110;
